...
stdenv.mkDerivation (finalAttrs: {
  ...
  meta = {
    description = "Open source XR runtime (pimax branch on fork)";
    homepage = "https://gitlab.freedesktop.org/Coreforge/monado/-/tree/pimax/";
    license = lib.licenses.boost;
    platforms = lib.platforms.linux;
    maintainers = with lib.maintainers; [ kaso ];
